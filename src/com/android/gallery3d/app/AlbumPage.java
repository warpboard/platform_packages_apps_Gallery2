...
public class AlbumPage extends ActivityState implements GalleryActionBar.ClusterRunner,
    ...
    // Note: actually selected item is not necessarily the one identified by
    // "suggestedSlotIndex" argument, because an item could also be unselected
    // by long press, not only be selected.
    private int handleSingleItemSelection(int suggestedSlotIndex) {
        int slotIndex = suggestedSlotIndex;
